...
export default function Error() {
  return (
    <div className='bg-slate-800 h-screen w-screen flex flex-col justify-center items-center text-center'>
      <Link href='/'>
        <img src='/headpats.png' className='w-40 h-40 rounded-xl hover:cursor-pointer' 
          onMouseOver={e => e.currentTarget.src='/headpats.gif'}
          onMouseOut={e => e.currentTarget.src='/headpats.png'}
